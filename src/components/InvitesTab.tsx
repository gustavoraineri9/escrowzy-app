...
import { Trophy, Users, DollarSign, Calendar, Check, X, Gamepad2 } from "lucide-react"; // Importei Gamepad2
...
          type: "tournament",
          from: {
            // Usa o perfil do owner do torneio
...
        const friendInvites: FriendInvite[] = friendRequests.map((f: any) => {
             ...
             const profile = f.sender_profile; 
...
// ... (Restante do useEffect, handlers e renderização)
// O restante do seu código não precisa de alterações na lógica de renderização ou handlers.
